...
class ProfissionalFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'profissional_fk' => ['type' => 'index', 'columns' => ['id_profissional'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'profissional_fk' => ['type' => 'foreign', 'columns' => ['id_profissional'], 'references' => ['tipo_profissional', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_criacao' => '2020-11-09 22:17:47',
                'id_profissional' => 1,
